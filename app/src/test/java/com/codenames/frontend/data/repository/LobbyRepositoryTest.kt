...
class LobbyRepositoryTest {
    ...
    @Test
    fun createLobby_shouldCallApiAndReturnResponse() =
        runTest {
            val username = "Max"
    ...
    @Test
    fun joinLobby_shouldCallApiWithCorrectParams() =
        runTest {
            val username = "Max"
            val lobbyCode = "1234"
    ...
    @Test
    fun leaveLobby_shouldCallApiWithCorrectParams() =
        runTest {
            val username = "Max"
            val lobbyCode = "1234"
    ...
    @Test
    fun getLobbyInfo_shouldCallApiWithCorrectParam() =
        runTest {
            val lobbyCode = "1234"
    ...
    @Test
    fun changeRole_shouldCreateCorrectPlayerDto() =
        runTest {
            val username = "Max"
            val lobbyCode = "1234"
    ...
    @Test
    fun createLobby_shouldThrowException_whenApiFails() =
        runTest {
            val username = "Max"
