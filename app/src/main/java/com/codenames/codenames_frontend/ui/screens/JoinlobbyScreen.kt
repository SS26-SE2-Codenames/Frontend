...
import com.codenames.codenames_frontend.ui.inputs.AppTextFieldKeyboard
import com.codenames.codenames_frontend.ui.inputs.AppTextFieldState
import com.codenames.codenames_frontend.ui.inputs.AppTextFieldStyle
...
internal fun isLobbyIdValid(lobbyId: String): Boolean {
    return lobbyId.isNotBlank()
}
